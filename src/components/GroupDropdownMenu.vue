      ...
      <transition name="fade" mode="out-in">
        <ul class="dropdown-menu" v-if="isOpen" ref="menu">
          <li class="item" ref="item">
            <icon-button icon="edit" content="Edit" :to="'/group/' + id"/>
          </li>
          <li class="item" ref="item">
            <icon-button icon="trash" content="Delete" @click.native="onClickButton('delete-group')"/>
          </li>
        </ul>
      </transition>
    </div>
...
<script lang="ts">
  ...
  export default class GroupDropdownMenu extends Vue {
